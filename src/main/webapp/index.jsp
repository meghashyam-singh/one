...
<body>
    ...
    <header>
        <h1>Welcome to Our HINDUSTAN UNIVERSITY</h1>
    </header>
    ...
    <section id="home">
        <h2>Home</h2>
        <p>Welcome to our university website. We are committed to providing quality education and fostering a vibrant learning environment.</p>
